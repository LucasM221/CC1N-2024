...
select id_produto, nome_pro, descricao, preco
from produtos;
...
select nome_pro, quantidade, id_armazem
from produtos as p
...
select id_produto, nome_pro, descricao, nome_for as nome_fornecedor
from produtos as p
...
select nome_armazem, pa.quantidade as qtd_produtos_armazenados
from armazens as a
